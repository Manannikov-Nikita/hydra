...
DEFERRED_HYDRA_MODULES = (
    ...
    "hydra_codex.dashboard_queries",
    "hydra_codex.dashboard_server",
    "hydra_codex.dashboard_sync",
    "hydra_codex.diagnostics",
    "hydra_codex.exact_time",
    "hydra_codex.hook_runtime",
    "hydra_codex.incremental_sync",
    "hydra_codex.install_layout",
    "hydra_codex.installation_cli",
    "hydra_codex.js_literal_fields",
    "hydra_codex.lineage",
    "hydra_codex.mcp_server",
    "hydra_codex.mcp_sync",
    "hydra_codex.migrations_aa27",
    "hydra_codex.migrations_ac29",
    "hydra_codex.migrations_i9",
    "hydra_codex.migrations_v22",
    "hydra_codex.migrations_y25",
    "hydra_codex.migrations_z26",
