...
from .migrations_n14 import N14_MIGRATIONS, N14_REQUIRED_SCHEMA
from .migrations_o15 import O15_MIGRATIONS, O15_REQUIRED_SCHEMA
from .migrations_p16 import P16_MIGRATIONS, P16_REQUIRED_SCHEMA
from .migrations_q17 import Q17_MIGRATIONS, Q17_REQUIRED_SCHEMA
from .migrations_r18 import (
    R18_MIGRATIONS,
...
from .migrations_u21 import (
    U21_DASHBOARD_PROJECTS_TABLE_SQL,
    U21_MIGRATIONS,
    U21_REQUIRED_SCHEMA,
)
...
) + B2_MIGRATIONS + C3_MIGRATIONS + D4_MIGRATIONS + E5_MIGRATIONS + F6_MIGRATIONS + G7_MIGRATIONS + H8_MIGRATIONS + I9_MIGRATIONS + J10_MIGRATIONS + K11_MIGRATIONS + L12_MIGRATIONS + M13_MIGRATIONS + N14_MIGRATIONS + O15_MIGRATIONS + P16_MIGRATIONS + Q17_MIGRATIONS + R18_MIGRATIONS + S19_MIGRATIONS + T20_MIGRATIONS + U21_MIGRATIONS
...
class HydraStore:
    ...
    def _validate_schema(self, latest: int) -> None:
        ...
        required.update(N14_REQUIRED_SCHEMA)
        required.update(O15_REQUIRED_SCHEMA)
        ...
        if (
            _table_schema_sql(self.connection, "pilot_receipts")
            != _normalized_schema_sql(R18_PILOT_RECEIPTS_TABLE_SQL)
        ):
            raise StorageUnavailable(
