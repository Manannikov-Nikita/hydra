...
class TestCommandGrammarTests(unittest.TestCase):
    def test_recognizes_supported_runners_and_runner_aware_scope(self) -> None:
        cases = {
            ...
            "python3.12 -m unittest discover -s tests": ("unittest", "full"),
            "python -m unittest": ("unittest", "full"),
            "python -m unittest tests.test_safe": ("unittest", "targeted"),
            "python -m unittest -k focused": ("unittest", "targeted"),
